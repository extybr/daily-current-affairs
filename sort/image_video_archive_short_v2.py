# Читает файл и если строка начинается с определенных символов (AAA, BBB) и заканчивается символами
# указанных расширений (.jpg, .mp4 и т.д.), то создает файл и записывает туда эту строку.
# Пример: строка 'AAAhttp://example.com/image.jpg' запишется в файл ls_image.txt,
# строка 'BBBhttp://example.com/video.mp4' запишется в файл ls_video.txt и так далее.
