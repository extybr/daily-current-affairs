#!/bin/bash
# $> ./veracrypt.sh m d  # монтирование диска
# $> ./veracrypt.sh m f 'path/to/file'  # монтирование образа диска
# $> ./veracrypt.sh u d  # размонтирование диска
# $> ./veracrypt.sh u f 'path/to/file'  # размонтирование образа диска
# $> ./veracrypt.sh fix d  # исправление файловой системы накопителя и монтирование диска
